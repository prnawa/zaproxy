default['zaproxy']['binary']['url'] = 'http://softlayer-sng.dl.sourceforge.net/project/zaproxy/2.3.1/ZAP_2.3.1_Linux.tar.gz'
default['zaproxy']['binary']['checksum'] = 'D4382891DA3F1AD5B6122C581A44C9ED'
default['zaproxy']['install_method'] = "binary"
default['zaproxy']['install_dir'] = "/opt/zaproxy-2.3.1"
